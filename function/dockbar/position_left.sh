...
sed -i "s/<position>Top<\/position>/<position>Left<\/position>/" ~/.config/openbox/rc.xml
sed -i "s/<position>Right<\/position>/<position>Left<\/position>/" ~/.config/openbox/rc.xml
sed -i "s/<position>Bottom<\/position>/<position>Left<\/position>/" ~/.config/openbox/rc.xml
